...
$pluginFile = $pluginRoot . '/ar-design-invoice-ledger.php';
...
if (!preg_match("/define\\(\\s*'AR_DESIGN_INVOICE_LEDGER_VERSION'\\s*,\\s*'" . preg_quote($version, '/') . "'\\s*\\)/", $pluginSource)) {
    $errors[] = 'AR_DESIGN_INVOICE_LEDGER_VERSION does not match VERSION file.';
}
